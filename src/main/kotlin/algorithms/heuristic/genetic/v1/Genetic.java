...
public class Genetic {
    ...
    public Genetic(int sizeMatrix, int sizePopulation, float txMutation, int txCrossover, final float txElitism, final boolean withRoulette, final Crossover crossover) {
    ...
    public Genetic(int sizeMatrix, int sizePopulation, float txMutation, int txCrossover, final float txElitism, final Crossover crossover) {
        this.matrix = MatrixGenerator.getInstance().getMatrix();
        this.fitnessToFind = MatrixGenerator.getInstance().getFitness();
        this.sizePopulation = sizePopulation;
        this.txMutation = txMutation;
