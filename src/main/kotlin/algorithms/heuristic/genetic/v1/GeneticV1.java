 ...
 * Algoritmo
 */
public class GeneticV1 implements Algorithm {
    ...
    public GeneticV1(int sizeMatrix, int sizePopulation, float txMutation, int txCrossover, final float txElitism, final boolean withRoulette, final Crossover crossover) {
    ...
    public GeneticV1(int sizeMatrix, int sizePopulation, float txMutation, int txCrossover, final float txElitism, final Crossover crossover) {
        this.matrix = MatrixGenerator.getInstance().getMatrix();
        this.fitnessToFind = MatrixGenerator.getInstance().getFitness();
        this.sizePopulation = sizePopulation;
        this.txMutation = txMutation;
...
//            Arrays.sort(fitness);
            ...
            if (bestFitnessOnThisGeneration != bestFitness) {
                ...
                if (bestFitnessOnThisGeneration <= fitnessToFind) {
                    ...
                    return new Output(Duration.ZERO);
                }
            }
