...
public final class MatrixGenerator {
    ...
    public void generateMatrix(final int SIZE) {
        generateMatrix(SIZE, false);
    }


    public int[] generateOrderingRoute(final int SIZE) {
    ...
    public int[] generateRandomRoute(final int SIZE) {

        final int[] array = generateOrderingRoute(SIZE);
    ...
    public void generateMatrix(final int SIZE, final boolean linear) {
