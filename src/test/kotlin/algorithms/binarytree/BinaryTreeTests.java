...
public class BinaryTreeTests {
    ...
    public void mustExecuteAndReturnPreOrderTraversalArray(final int[] arrayToSort, final int[] expectedSortedArray) {
        ...
        final var sortedArray = BinaryTree.executeAndReturnInOrderTraversal(arrayToSort);
    ...
    public void mustRunTreeInPreOrderTraversal() {
        ...
        final var arrayReturned = BinaryTree.executeAndReturnPreOrderTraversal(arrayToSort);
    ...
    public void mustRunTreeInPostOrderTraversal() {
        ...
        final var arrayReturned = BinaryTree.executeAndReturnPostOrderTraversal(arrayToSort);
