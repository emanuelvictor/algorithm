...
public class MinMaxSelectionSortTest {
    ...
    static Stream<Arguments> provideShuffleAndSortedArray() {
        ...
        return Stream.of(
                ...
                Arguments.of(new int[]{23, 25, 12, 3, 22, 11, 1, 2, 4, 5, 6}, new int[]{1, 2, 3, 4, 5, 6, 11, 12, 22, 23, 25}),
