...
public class SearchIntersectionBetweenTwoArraysBruteForceTest {
    ...
    public void mustExtractTheIntersectionWhenAllElementsAreRepeated() {
        ...
        final var searchIntersectionBetweenTwoArrays = new SearchIntersectionBetweenTwoArraysBruteForce(firstArray, secondArray);
