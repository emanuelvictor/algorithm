...
public class SearchIntersectionBetweenTwoArraysUtilizingLanguageTest {
    ...
    public void mustExtractTheIntersectionWhenAllElementsAreRepeated() {
        ...
        final var searchIntersectionBetweenTwoArrays = new SearchIntersectionBetweenTwoArraysUtilizingLanguage(firstArray, secondArray);
